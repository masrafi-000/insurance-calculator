...
function Tooltip({ text }: { text: string }) {
  ...
  return (
    <span
      className="relative inline-flex items-center justify-center w-[18px] h-[18px] rounded-full cursor-pointer text-[12px] font-black text-blue-500 bg-blue-50 border border-blue-200 flex-shrink-0 select-none outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
...
function Field({
  ...
  return (
    <div className="bg-white/60 border border-slate-200/70 rounded-2xl p-3.5 shadow-sm backdrop-blur-sm transition-all duration-200 focus-within:-translate-y-px focus-within:border-blue-400/50 focus-within:shadow-[0_0_0_4px_rgba(59,130,246,0.1),0_8px_20px_rgba(0,0,0,0.07)]">
      <label className="flex items-center gap-1.5 text-[14px] font-bold text-slate-700 mb-2">
        {label}
...
const inputCls =
  "w-full px-3 py-2.5 rounded-xl border border-slate-200/60 bg-white/80 text-sm text-[#2C2C2E] text-3xl placeholder-slate-400 outline-none transition-all duration-150 focus:border-blue-400 focus:ring-[3px] focus:ring-blue-200/60 appearance-none";
...
function KpiCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-1.5 text-[22px] font-extrabold tracking-tight text-[#2C2C2E] text-3xl leading-none">
        {value}
      </div>
    </div>
  );
...
export default function InsuranceClaculator() {
  ...
  return (
    <div className=" text-[#2C2C2E] text-3xl bg-gradient-to-br from-slate-50 via-blue-50/30 rounded-2xl to-slate-100 relative overflow-hidden">
      {/* Ambient blobs */}
      <div
      ...
      <div className="relative z-10 max-w-[960px]  mx-auto px-5 py-12">
        <div className="bg-white/60 border border-white/70 rounded-[26px] p-8 shadow-[0_20px_50px_rgba(59,130,246,0.12)] backdrop-blur-2xl">
          ...
          {/* ── Error ── */}
          {error && (
            <div className="mt-3.5 px-4 py-3 rounded-xl bg-rose-50 border border-rose-200/60 text-rose-700 text-[15px]">
          ...
          {/* ── Notice ── */}
          {notice && (
            <div className="mt-3.5 px-4 py-3 rounded-xl bg-blue-50 border border-blue-200/50 text-blue-800 text-[15px]">
          ...
          {results && (
            <div ref={resultsRef}>
              ...
              <div className="mt-7 flex items-center gap-3">
                <p className="text-[12px] font-black uppercase tracking-widest text-blue-400">
                  Résultats
                </p>
              ...
              <div className="mt-4 p-5 rounded-2xl bg-gradient-to-br from-blue-50/70 to-white/60 border border-blue-100/60 shadow-sm">
                <h3
                  className="text-[15px] font-extrabold tracking-tight text-[#2C2C2E] 
                "
                >
                  Aller plus loin
                </h3>
                ...
                <div className="flex flex-wrap gap-2.5 mt-4">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl bg-gradient-to-b from-blue-500 to-blue-600 border border-blue-700/40 text-white text-[15px] font-bold shadow-[0_6px_18px_rgba(59,130,246,0.3)] transition-all hover:-translate-y-px hover:brightness-105 active:scale-[0.99]"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl bg-white/70 border border-slate-200/70 text-slate-700 text-[15px] font-bold shadow-sm transition-all hover:-translate-y-px hover:bg-white active:scale-[0.99]"
                  >
